...
- For alpha or other pre-releases, use a PEP 440 package version such as `1.0.13a4` and push the matching Git tag `v1.0.13a4`.
...
9. Publish package distributions to PyPI via PyPA Trusted Publishers (`pypa/gh-action-pypi-publish`).
