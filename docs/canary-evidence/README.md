...
- State: 50-workflows checkpoint clean; cumulative `50/50` accepted workflows, `0` incidents, `0` rollback actions
...
| --- | --- | --- | --- |
| `1e68a8b` | active replacement beta canary after a clean `50/50` early-window checkpoint | yes | Active replacement beta candidate for the held `v1.0.13b1` line; this is the current Phase 16 admission path. |
