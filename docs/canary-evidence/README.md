...
- State: first-admitted checkpoint clean; cumulative `3/3` accepted workflows, `0` incidents, `0` rollback actions
...
| --- | --- | --- | --- |
| `1e68a8b` | active replacement beta canary after a clean `3/3` first-admitted batch | yes | Active replacement beta candidate for the held `v1.0.13b1` line; this is the current Phase 16 admission path. |
