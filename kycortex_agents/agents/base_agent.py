    ...
    def _provider_health_metadata(
        ...
        for provider_name, model_name in provider_plan:
            ...
            if isinstance(public_last_health_check, dict):
                public_last_health_check.pop("backend_reachable", None)
                public_last_health_check.pop("base_url", None)
                public_last_health_check.pop("timeout_seconds", None)
                public_last_health_check.pop("model", None)
                public_last_health_check.pop("model_ready", None)
                public_last_health_check.pop("retryable", None)
                public_last_health_check.pop("latency_ms", None)
                public_last_health_check.pop("provider", None)
                public_last_health_check.pop("cooldown_remaining_seconds", None)
