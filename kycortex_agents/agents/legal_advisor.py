...
LEGAL_OUTPUT_DISCLAIMER = (
    "DISCLAIMER: This document was generated by an AI language model. "
    "It is informational output only, is not a certified legal review, and does not "
    "constitute legal advice. Consult a qualified lawyer before acting on its contents."
)
...
Always note: your output is generated by an AI language model, is informational only, and is not legal advice."""

class LegalAdvisorAgent(BaseAgent):
    output_artifact_type = ArtifactType.DOCUMENT
    output_artifact_name = "legal_analysis"
    output_artifact_disclaimer = LEGAL_OUTPUT_DISCLAIMER
