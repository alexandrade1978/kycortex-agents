...
class ProjectState:
    ...
    def snapshot(self) -> ProjectSnapshot:
        ...
        return ProjectSnapshot(
            ...
            phase=self.phase,
            acceptance_evaluation=public_acceptance_evaluation,
            has_started_at=isinstance(self.workflow_started_at, str) and bool(self.workflow_started_at),
            has_finished_at=isinstance(self.workflow_finished_at, str) and bool(self.workflow_finished_at),
    ...
    def _workflow_telemetry_summary(self) -> WorkflowTelemetry:
        ...
        for provider_name in sorted(provider_summary):
            ...
            normalized_provider_summary[provider_name] = {
                "has_multiple_tasks": int(raw_summary.get("task_count", 0)) > 1,
        ...
        return {
            ...
            "has_multiple_final_providers": len(final_providers) > 1,
            "has_multiple_observed_providers": len(observed_providers) > 1,
