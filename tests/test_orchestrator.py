...
def test_execute_generated_tests_returns_unavailable_when_pytest_missing(tmp_path, monkeypatch):
    ...
    result = sandbox_execution_module.execute_generated_tests_runtime(
        config.execution_sandbox_policy(),
        "generated_module.py",
        "def ok():\n    return 1",
        "generated_tests.py",
...
def test_analyze_test_behavior_contracts_accepts_complete_builder_batch_items_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
        ...
        "    requests = [\n"
        "        builder.build_item('user-1', 'eu', {'name': 'Ada', 'email': 'ada@example.com'}),\n"
        "        builder.build_item('user-2', 'eu', {'name': 'Bob', 'email': 'bob@example.com'}),\n"
        "    ]\n"
        "    process_batch(requests)\n"
    )
...
def test_analyze_test_behavior_contracts_accepts_complete_nested_builder_batch_items_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
        ...
        "    requests = [\n"
        "        builder.build_item('user-1', 'eu', {'request_id': 'id-1', 'payload': {'name': 'Ada', 'email': 'ada@example.com'}}),\n"
        "        builder.build_item('user-2', 'eu', {'request_id': 'id-2', 'payload': {'name': 'Bob', 'email': 'bob@example.com'}}),\n"
        "    ]\n"
        "    process_batch(requests)\n"
    )
...
def test_analyze_test_behavior_contracts_allows_partial_invalid_builder_batch_with_unsupported_values_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_allows_partial_invalid_nested_builder_batch_with_unsupported_values_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_with_pytest_raises_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_result_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_is_none_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_none_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_invalid_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_failed_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_error_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_pending_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_rejected_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_result_compare_equals_reject_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_result_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_is_none_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_none_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_invalid_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_failed_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_error_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_pending_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_rejected_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_result_compare_equals_reject_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_pending_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_rejected_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_failed_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_error_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_reject_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_failed_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_error_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_pending_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_rejected_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_reject_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_state_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_validity_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_validity_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_is_valid_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_is_valid_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_is_valid_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_success_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_success_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_accepted_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_success_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_accepted_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_builder_batch_unsupported_values_when_invalid_accepted_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_pending_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_rejected_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_failed_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_error_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_reject_status_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_failed_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_error_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_pending_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_rejected_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_reject_outcome_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_state_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_validity_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_validity_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_validity_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_is_valid_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_is_valid_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_success_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_success_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_success_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_accepted_flag_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_accepted_compare_equals_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_accepted_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_analyze_test_behavior_contracts_ignores_nested_builder_batch_unsupported_values_when_invalid_is_valid_compare_is_false_is_expected_without_builder_metadata(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"))
    Orchestrator(config)
    tree = ast.parse(
        "def test_case():\n"
...
def test_negative_expectation_helpers_cover_pytest_raises_and_invalid_outcome_paths(tmp_path):
    ...
    for state_marker in ("Invalid", "Pending", "Rejected", "Failed", "Error", "Reject"):
        state_tree = ast.parse(
            "def test_invalid_state_case():\n"
            "    payload = {'state': 'invalid'}\n"
            "    with pytest.raises(ValueError):\n"
            "        validate_request(payload)\n"
            "    result = validate_request(payload)\n"
            f"    assert payload.state == '{state_marker}'\n"
        )
        state_test_node = state_tree.body[0]
        assert isinstance(state_test_node, ast.FunctionDef)
        state_call_nodes = [
            node
            for node in ast.walk(state_test_node)
            if isinstance(node, ast.Call) and callable_name(node) == "validate_request"
        ]
        state_parent_map_by_node = parent_map(state_tree)

        negative_state_call = next(node for node in state_call_nodes if node.lineno == 4)
        followup_state_call = next(node for node in state_call_nodes if node.lineno == 5)
    ...
    for result_marker in ("Invalid", "Pending", "Rejected", "Failed", "Error", "Reject"):
        result_tree = ast.parse(
            "def test_invalid_result_case():\n"
            "    payload = {'result': 'invalid'}\n"
            "    with pytest.raises(ValueError):\n"
            "        validate_request(payload)\n"
            "    result = validate_request(payload)\n"
            f"    assert payload.result == '{result_marker}'\n"
        )
        result_test_node = result_tree.body[0]
        assert isinstance(result_test_node, ast.FunctionDef)
        result_call_nodes = [
            node
            for node in ast.walk(result_test_node)
            if isinstance(node, ast.Call) and callable_name(node) == "validate_request"
        ]
        result_parent_map_by_node = parent_map(result_tree)

        negative_result_call = next(node for node in result_call_nodes if node.lineno == 4)
        followup_result_call = next(node for node in result_call_nodes if node.lineno == 5)
    ...
    for bool_attr in ("valid", "is_valid", "success", "accepted"):
        none_tree = ast.parse(
            f"def test_none_{bool_attr}_case():\n"
            f"    payload = {{'{bool_attr}': None}}\n"
            "    with pytest.raises(ValueError):\n"
            "        validate_request(payload)\n"
            "    result = validate_request(payload)\n"
            f"    assert payload.{bool_attr} is None\n"
        )
        none_test_node = none_tree.body[0]
        assert isinstance(none_test_node, ast.FunctionDef)
        none_call_nodes = [
            node
            for node in ast.walk(none_test_node)
            if isinstance(node, ast.Call) and callable_name(node) == "validate_request"
        ]
        none_parent_map_by_node = parent_map(none_tree)

        negative_none_call = next(node for node in none_call_nodes if node.lineno == 4)
        followup_none_call = next(node for node in none_call_nodes if node.lineno == 5)
...
def test_batch_result_helpers_cover_reverse_comparisons_and_fallback_cases(tmp_path):
    ...
    for bool_attr in ("valid", "is_valid", "success", "accepted"):
        req_none_assert = parse_assert_node(f"assert request.{bool_attr} is None")
        assert assert_expects_invalid_outcome(req_none_assert.test, None, "request") is True
    for bool_attr in ("valid", "is_valid", "success", "accepted"):
...
def test_run_task_allows_missing_required_fields_for_intentional_rejected_status_assertion(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"), timeout_seconds=30.0)
    project = ProjectState(project_name="Demo", goal="Build demo")
    code_content = (
        "class ComplianceRequest:\n"
...
def test_run_task_allows_missing_required_fields_for_intentional_failed_status_assertion(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"), timeout_seconds=30.0)
    project = ProjectState(project_name="Demo", goal="Build demo")
    code_content = (
        "class ComplianceRequest:\n"
...
def test_run_task_allows_missing_required_fields_for_intentional_error_status_assertion(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"), timeout_seconds=30.0)
    project = ProjectState(project_name="Demo", goal="Build demo")
    code_content = (
        "class ComplianceRequest:\n"
...
def test_run_task_allows_missing_required_fields_for_intentional_reject_status_assertion(tmp_path):
    config = KYCortexConfig(output_dir=str(tmp_path / "output"), timeout_seconds=30.0)
    project = ProjectState(project_name="Demo", goal="Build demo")
    code_content = (
        "class ComplianceRequest:\n"
...
def test_run_task_sanitizes_custom_provider_call_metadata_in_output_payload(tmp_path):
    ...
    assert "has_last_error_type" not in project.tasks[0].last_provider_call["provider_health"]["openai"]
    assert "last_error_type" not in project.tasks[0].last_provider_call["provider_health"]["openai"]
    assert "has_last_error_message" not in project.tasks[0].last_provider_call["provider_health"]["openai"]
    ...
    assert "has_last_error_type" not in payload["metadata"]["provider_call"]["provider_health"]["openai"]
    assert "last_error_type" not in payload["metadata"]["provider_call"]["provider_health"]["openai"]
    assert "has_last_error_message" not in payload["metadata"]["provider_call"]["provider_health"]["openai"]
...
def test_import_insertion_line_handles_shebang_coding_comment_and_future_imports(tmp_path):
    ...
    # L129-130: shebang and coding comment
    shebang_code = "#!/usr/bin/env python3\n# -*- coding: utf-8 -*-\ndef foo():\n    pass\n"
    tree_shebang = ast.parse(shebang_code)
    insert_shebang = _import_insertion_line(shebang_code, tree_shebang)
    assert insert_shebang >= 2

    # L138-141: docstring as first statement
    docstring_code = '"""Module docstring."""\ndef bar():\n    pass\n'
    tree_docstring = ast.parse(docstring_code)
    insert_docstring = _import_insertion_line(docstring_code, tree_docstring)
    assert insert_docstring >= 1

    # L145-148: __future__ import
