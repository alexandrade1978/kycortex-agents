...
def test_release_status_documents_current_repository_release_readiness_state():
    ...
    assert "continue the active canary to the 50-eligible-workflow checkpoint or daily review, whichever comes first, and preserve the next repository-owned evidence packet" in release_status
