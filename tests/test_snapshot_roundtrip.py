...
def test_snapshot_round_trip_preserves_mixed_task_state_integrity(tmp_path, state_filename):
    ...
    assert snapshot.workflow_telemetry == {
        ...
        "has_multiple_final_providers": True,
        ...
        "provider_summary": {
            "ollama": {
                ...
                "duration_ms": {"has_multiple_samples": False, "total": 125, "min": 125, "max": 125, "avg": 125},
                "usage": {},
            },
            "openai": {
                "has_multiple_tasks": False,
                ...
                "has_attempts": False,
                "has_retry_attempts": False,
                "duration_ms": {"has_multiple_samples": False, "total": 120.5, "min": 120.5, "max": 120.5, "avg": 120.5},
                "usage": {"completion_tokens": 5, "prompt_tokens": 10, "total_tokens": 15},
            },
        },
        ...
        "has_attempts": False,
        "has_retry_attempts": False,
        "duration_ms": {"has_multiple_samples": True, "total": 245.5, "min": 120.5, "max": 125, "avg": 122.75},
        "usage": {"completion_tokens": 5, "prompt_tokens": 10, "total_tokens": 15},
        "fallback_summary": {
            "has_multiple_tasks": False,
            "has_entries": False,
